...
const GuidePanel = {
  ...
  render() {
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div style="margin-top:12px;font-size:var(--font-size-sm);color:var(--text-muted);line-height:1.7">
            Best use: treat each imported item as a decision candidate. Code imports are now analyzed automatically, linked into <strong>Features</strong> by default, switched into <strong>Improve</strong> when the match looks like a refinement, and given a reusable checklist you can copy or push into implementation.
          </div>
        </div>
      </div>
    ...
    <div class="grid-2" style="margin-top:16px">
      <div class="card">
        <div class="card-body">
          <h3 class="section-title" style="color:var(--accent-pink);margin-bottom:10px">Target App: Company X1 PM</h3>
          ...
          <div class="btn-row" style="margin-top:14px">
            <button class="btn btn-green" onclick="MockupManager.loadBundledSet('company-x1')">📦 Load Recommended Set</button>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-body">
          <h3 class="section-title" style="color:var(--accent-green);margin-bottom:10px">Target App: Marex Dynamic PM</h3>
          <div style="font-size:var(--font-size-sm);color:var(--text-secondary);line-height:1.7">
          ...
          <div class="btn-row" style="margin-top:14px">
            <button class="btn btn-green" onclick="MockupManager.loadBundledSet('marex-dynamic')">📦 Load Recommended Set</button>
          </div>
        </div>
      </div>
    </div>
